...
@ViewModelWithArgs
class StockItemListFragmentViewModel : PagerListFragmentViewModel<Item>() {

    @Argument
    override lateinit var context: Context

    override fun useCase(): RxUseCase<List<Item>> {
        return qiiipApplication.useCases.getMyStockItems(currentPageValue, Settings.app.perPage)
    }
}