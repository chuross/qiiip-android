...
import com.github.chuross.qiiip.ui.EmptyTemplate
import com.github.chuross.qiiip.ui.activity.LoginActivity
import org.apache.commons.lang3.exception.ExceptionUtils
import rx.Observable
import javax.inject.Inject

class LoginActivityPresenter(activity: LoginActivity) : ActivityPresenter<LoginActivity, EmptyTemplate>(activity) {

    @Inject
    lateinit var api: QiitaV2Api

    override fun createTemplate(p0: LoginActivity?): EmptyTemplate = EmptyTemplate(view)
    ...
    fun onRequestSuccess() {
        ...
        Toast.makeText(view, "success!", Toast.LENGTH_LONG).show()
        view.finish()
    }

    fun onRequestFailed(tr: Throwable) {
        //TODO show success message
        Toast.makeText(view, "failed!${ExceptionUtils.getStackTrace(tr)}", Toast.LENGTH_LONG).show()
    }
}